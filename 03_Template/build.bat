...
link.exe Source.obj Resources\Fire\Text.res Scene/Cloth/Clothcu.obj Cloth.obj user32.lib gdi32.lib kernel32.lib opengl32.lib "C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v10.1\lib\x64\cudart.lib" "Include\ExternalLibraries\Assimp\Lib\assimp-vc140-mt.lib" /MACHINE:X64
