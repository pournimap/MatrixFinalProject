...
link.exe Source.obj Resources\Fire\Text.res Scene/Cloth/Clothcu.obj Cloth.obj user32.lib gdi32.lib kernel32.lib opengl32.lib "C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v10.2\lib\x64\cudart.lib" /MACHINE:X64
